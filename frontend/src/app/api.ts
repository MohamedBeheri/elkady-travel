...
export const api = createApi({
  ...
  endpoints: (b) => ({
    ...
    deleteEmptyTrip: b.mutation<any, number>({
      query: (id) => ({ url: `operations/daily-trips/${id}/remove-if-empty/`, method: 'DELETE' }),
      invalidatesTags: ['DailyTrip', 'SeatRequest'],
    }),
